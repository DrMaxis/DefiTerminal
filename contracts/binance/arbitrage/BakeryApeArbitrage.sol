...
contract BakeryApeArbitrage {
    ...
    address ApeFactory;
    address ApeRouter;
    constructor(address bakeryFactory, address apeFactory, address wethAddress, address bakeryRouter, address apeRouter,  address beneficiaryAddress) public {

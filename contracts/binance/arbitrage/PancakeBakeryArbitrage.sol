...
contract PancakeBakeryArbitrage {
    ...
    address Beneficiary;
    constructor(address pancakeFactory, address bakeryFactory, address wethAddress, address pancakeRouter, address bakeryRouter, address beneficiaryAddress) public {

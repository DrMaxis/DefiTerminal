...
contract PancakeBakeryArbitrage {
    IWeth immutable WETH;
    address Beneficiary;
    address BakerySwapFactory;
    address PancakeFactory;
    address PancakeRouter;
    address BakeryRouter;
    constructor(address pancakeFactory, address bakeryFactory, address wethAddress , address bakeryRouter, address pancakeRouter, address beneficiaryAddress) public {
        BakerySwapFactory = bakeryFactory;

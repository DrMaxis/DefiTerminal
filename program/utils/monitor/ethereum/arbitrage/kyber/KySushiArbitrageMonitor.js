...
async function fetchData(data) {
  let stableToken, tradingToken, web3, kyber, sushiswap, admin;
  ...
  web3.eth.subscribe('newBlockHeaders')
    .on('data', async block => {
      ...
      const profit1 = (parseInt(AMOUNT_TRADINGTOKEN_WEI) / 10 ** 18) * (kyberRates.sell - sushiswapEthBuyPrice)  * currentEthPrice;
      const profit2 = (parseInt(AMOUNT_TRADINGTOKEN_WEI) / 10 ** 18) * (sushiswapEthSellPrice - kyberRates.buy)  * currentEthPrice;
      if(profit1 > 0) {
